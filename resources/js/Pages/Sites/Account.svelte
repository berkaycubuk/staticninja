    ...
    <div class="flex items-center justify-center">
        ...
        <Card classes="w-full">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div>
                    <a href="/sites/account/settings" use:inertia class="block w-fit">
                        <Button design="secondary" text="Settings" />
                    </a>
                </div>

                <div>
                    <a href="/sites/logout" use:inertia class="block w-fit">
                        <Button design="danger" text="Logout" />
                    </a>
                </div>

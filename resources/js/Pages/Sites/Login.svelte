...
<AuthLayout title="Login">
    <div class="flex items-center justify-center">
        ...
        <Card classes="max-w-[480px] w-full">
            <h1 class="text-center text-xl font-semibold">Log in to Static Ninja Sites</h1>
            ...
            <div class="flex flex-col gap-4 mt-4">
                ...
                <div class="text-center">
                    <a use:inertia class="underline" href="/sites/reset-password">Forgot your password?</a>
                </div>
                ...
                <div class="text-center">
                    <a use:inertia class="underline" href="/sites/register">Don't have an account? Register</a>
                </div>
            </div>
        </Card>
